<div>
  <ol class="flex flex-wrap items-center mb-2 fi-breadcrumbs-list gap-x-2">
      ...
      <li class="flex fi-breadcrumbs-item gap-x-2">
                @if (!$loop->first)
          <svg class="flex w-5 h-5 text-gray-400 fi-breadcrumbs-item-separator rtl:hidden"
          ...
          <svg class="flex w-5 h-5 text-gray-400 fi-breadcrumbs-item-separator ltr:hidden"
          ...
          class="text-sm font-medium text-gray-500 transition duration-75 fi-breadcrumbs-item-label hover:text-gray-700">
                    {{ $breadcrumb }}
                </a>
            </li>
        @endforeach
